package com.assignment.arraystream;
...
public class StringArray {
	...
	public static void main(String[] args) {
        ...
        List<String> arr = new ArrayList<>(Arrays.asList("before", "software", "can", "be", "reusable", "it", "has", "first", "to", "be", "usable")); 
        ...
        Stream.concat(
        		arr.stream().filter(s -> s.contains("e")),
        		arr.stream().filter(s -> !s.contains("e")))
        .forEach(System.out::println);
